...
class DatasetConverter:
    ...
    def _get_stp_ttp_settings(self) -> dict[str, Any]:
        r"""Get per-dataset stp and ttp settings to include in output."""
        return {
            "_use_stp": self.dataset_attr.use_stp,
            "_use_ttp": self.dataset_attr.use_ttp,
        }
