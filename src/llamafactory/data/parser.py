...
class DatasetAttr:
    ...
    # per-dataset stp and ttp settings (None means use global settings from model_args)
    use_stp: bool | None = None
    ...
    def join(self, attr: dict[str, Any]) -> None:
        ...
        # per-dataset stp and ttp settings
        self.set_attr("use_stp", attr)
        self.set_attr("use_ttp", attr)
